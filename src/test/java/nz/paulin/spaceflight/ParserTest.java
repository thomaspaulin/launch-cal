...
public class ParserTest extends Assert {
    ...
    public void missionParsing_MonthButNoDay_EmptyResultList() throws ParseException {
        ...
        assertTrue(Parser.parseLaunches(html, logger).isEmpty());
    }
    ...
    //todo add test case that checks the exclusion of the related articles section
